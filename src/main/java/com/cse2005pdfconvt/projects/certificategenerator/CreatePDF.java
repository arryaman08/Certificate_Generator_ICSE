...
public class CreatePDF {
    ...
    public static void generate(Certificate certificate) throws FileNotFoundException, MalformedURLException, IOException{
       ...
       Text segmentText1= new Text("\n\nFor successfully passing Class X from ");
       Text segmentText2= new Text(courseName);
       Text segmentText3= new Text(" by excelling in board examinations conducted by the ");
       Text segmentText8= new Text("Council for the Indian School Certificate Examinations(");
       Text segmentText4= new Text(departmentName);
       
       Text segmentText5= new Text(").\n");
       Text segmentText6= new Text(firstPronoun);
       Text segmentText7= new Text(" demonstrated a strong understanding of the course objectives");
    ...
    //   firstText.setFontSize(13f);
       ...
       Text secondSegmentText3= new Text(" dedication to learning and determination to succeed in future endeavours.");
    /*   // Text secondSegmentText4= new Text(departmentName);
      ...
      /*  secondParagraph.add(secondSegmentText4);
       ...
       // Signature
       Text instName= new Text("Gerry Arathoon\n");
       instName.setFontSize(13f);
       Text postName=new Text("Secretary, CISCE");
